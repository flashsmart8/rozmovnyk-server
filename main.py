...
# Чоловічі: Daniel, George
# Жіночі: Charlotte, Alice
VOICE_MAP = {
    "waiter":    "onwK4e9ZLuTAKqWW03F9",  # Daniel — British male
    "hotel":     "XB0fDUnXU5powFXDhCwa",  # Charlotte — British female
    "airport":   "Xb7hH8MSUJpSbSDYk0k2",  # Alice — British female
    "shop":      "XB0fDUnXU5powFXDhCwa",  # Charlotte — British female
    "colleague": "JBFqnCBsd6RMkjVDRZzb",  # George — British male
    "friend":    "Xb7hH8MSUJpSbSDYk0k2",  # Alice — British female
}
